...
- `version` (string): either "4" or "6" and corresponds to the IP version of the addresses and routes in the entry.
   All IP addresses and routes provided must be valid for the given `version`.

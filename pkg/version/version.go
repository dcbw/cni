...
func NewResult(version string, resultBytes []byte) (types.Result, error) {
	...
	for _, resultVersion := range resultVersions {
		err := reconciler.CheckRaw(version, resultVersion.supportedVersions)
		if err == nil {
			// Result supports this version
			return resultVersion.newResult(resultBytes)
		}
	}
